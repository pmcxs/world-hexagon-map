...
namespace WorldHexagonMap.Core.Test
{
    public class HexagonServiceTests
    {
        ...
        {
            var result = _service.IsPointXYInsideHexagonLocationUV(new PointXY(x, y), new HexagonLocationUV(u, v),
                _hexagonDefinition);
        ...
        {
            var resultsA =
                _service.GetHexagonsInsideBoudingBox(new PointXY(0, -20), new PointXY(450, 100), _hexagonDefinition);
            ...
            var resultsB =
                _service.GetHexagonsInsideBoudingBox(new PointXY(0, -20), new PointXY(320, 20), _hexagonDefinition);
            ...
            var resultsC =
                _service.GetHexagonsInsideBoudingBox(new PointXY(150, -20), new PointXY(320, 20), _hexagonDefinition);
        ...
        {
            var points = _service.GetPointsXYOfHexagon(new HexagonLocationUV(0, 0), _hexagonDefinition);
