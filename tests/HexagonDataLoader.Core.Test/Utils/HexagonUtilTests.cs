...
namespace HexagonDataLoader.Core.Test.Utils
{
    public class HexagonUtilTests
    {
        private readonly HexagonDefinition _hexagonDefinition = new HexagonDefinition(100, 10);
